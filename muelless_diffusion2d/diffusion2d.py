...
"""
Soves the 2D diffusion equiation and produces a plot.

Parameters
----------
dx, dy : float
    Step sizes in x and y direction.
D : float
   Diffusion. 
"""
def solve(dx=0.1, dy=0.1, D=4):
    ...
    for n in range(nsteps):
        ...
        if n in n_output:
            fig_counter += 1
            im = create_plot(fig_counter, u, n, dt, T_cold, T_hot, fig) # python scopes are weird...
